...
import com.min429.tourism_platform_server.common.exception.handler.jwt.JwtAccessDeniedHandler;
...
import com.min429.tourism_platform_server.common.service.jwt.JwtUserDetailsService;
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.addFilterBefore(jwtAuthenticationFilter(jwtProvider(jwtProperties()), jwtAuthenticationEntryPoint()),
